...
REPLACE INTO "ci_sessions" ("session_id", "ip_address", "user_agent", "last_activity", "user_data") VALUES
	('b5f294e4178547bdbc23c29165974b09','127.0.0.1','Mozilla/5.0 (Windows; U; Windows NT 5.1; en-GB; rv','1227474590','');
...
) AUTO_INCREMENT=3 /*!40100 DEFAULT CHARSET=latin1 COMMENT='Security groups'*/;
...
REPLACE INTO "users" ("user_id", "group_id", "department_id", "enabled", "username", "firstname", "lastname", "email", "password", "password-expire", "displayname", "ext", "cookiekey", "lastlogin", "ldap", "created") VALUES
	('1',1,'0',1,'admin',NULL,NULL,'craig.rodway@gmail.com','5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8',NULL,NULL,NULL,NULL,'2008-11-23 18:44:21',0,'0000-00-00');
REPLACE INTO "users" ("user_id", "group_id", "department_id", "enabled", "username", "firstname", "lastname", "email", "password", "password-expire", "displayname", "ext", "cookiekey", "lastlogin", "ldap", "created") VALUES
