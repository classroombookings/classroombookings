...
INSERT INTO `ci_sessions` (`session_id`, `ip_address`, `user_agent`, `last_activity`, `user_data`) VALUES
	('0bab12278e7435aeb7f49162e3905602','127.0.0.1','Mozilla/5.0 (Windows; U; Windows NT 5.1; en-GB; rv','1227629273','');
...
INSERT INTO `settings-auth` (`ldap`, `ldaphost`, `ldapport`, `ldapbase`, `preauthkey`) VALUES
...
INSERT INTO `settings-main` (`schoolname`, `schoolurl`, `bd_mode`, `bd_col`) VALUES
	('Bishop Barrington School Sports With Mathematics College','http://www.bishopbarrington.net/','day','periods');
...
CREATE TABLE `users` (
  ...
  PRIMARY KEY  (`user_id`),
  KEY `ldap` (`ldap`)
) TYPE=InnoDB AUTO_INCREMENT=3 /*!40100 DEFAULT CHARSET=latin1 COMMENT='Main users table'*/;
...
INSERT INTO `users` (`user_id`, `group_id`, `department_id`, `enabled`, `username`, `firstname`, `lastname`, `email`, `password`, `password-expire`, `displayname`, `ext`, `cookiekey`, `lastlogin`, `ldap`, `created`) VALUES
	...
	('2',1,'0',0,'craig',NULL,NULL,'craig.rodway@bishopbarrington.net','test',NULL,NULL,NULL,NULL,'0000-00-00 00:00:00',0,'2008-11-23');
