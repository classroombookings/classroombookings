...
) TYPE=InnoDB AUTO_INCREMENT=6 /*!40100 DEFAULT CHARSET=latin1 COMMENT='School holidays'*/;
...
) TYPE=InnoDB AUTO_INCREMENT=68 /*!40100 DEFAULT CHARSET=latin1 COMMENT='Periods'*/;
...
) TYPE=InnoDB AUTO_INCREMENT=12 /*!40100 DEFAULT CHARSET=latin1 COMMENT='Term dates'*/;
...
) TYPE=InnoDB AUTO_INCREMENT=25 /*!40100 DEFAULT CHARSET=latin1 COMMENT='Main users table'*/;
...
INSERT INTO `users` (`user_id`, `group_id`, `enabled`, `username`, `email`, `password`, `displayname`, `cookiekey`, `lastlogin`, `ldap`, `created`) VALUES
	('1','1',1,'admin','craig.rodway@gmail.com','5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8','Craig Rodway',NULL,'2009-01-26 10:15:43',0,'0000-00-00'),
...
) TYPE=InnoDB AUTO_INCREMENT=16 /*!40100 DEFAULT CHARSET=latin1 COMMENT='Week definitions for timetable weeks'*/;
