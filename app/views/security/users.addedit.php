...
<table class="form" cellpadding="6" cellspacing="0" border="0" width="50%">
	...
	<tr>
		...
		<td class="field">
		  <?php
			echo form_dropdown('group_id', $groups, @set_select('group_id', $user->group_id), array('tabindex' => $t));
			$t++;
			?>
		</td>
	</tr>
	...
	<tr>
		<td class="caption">
			<label for="enabled" accesskey="E" title="Tick this box to prevent the user from logging in. This also applies to LDAP users."><u>E</u>nabled</label>
		</td>
		<td class="field">
	...
	<tr>
		...
		<td class="field">
		  <?php
			echo @form_dropdown('deptartment_id', $departments, @set_select('department_id', $user->department_id), array('tabindex' => $t));
			$t++;
			?>
		</td>
	</tr>
